...
public:
  Socket(ba::io_service &_ioService, ba::ssl::context &_sslContext,
  ...
  virtual ba::ssl::stream<bi::tcp::socket> &sslref() override {
    return *m_sslSocket;
  }

  virtual const NodeIPEndpoint &nodeIPEndpoint() const override {
