...
namespace bcos {
namespace gateway {
class Gateway : public GatewayInterface, std::enable_shared_from_this<Gateway> {
public:
...
public:
   ...
   */
  void
  asyncSendMessageByNodeIDWithRetry(std::shared_ptr<P2PMessage> _p2pMessage,
   ...
   * @return bool
   */
  virtual bool registerFrontService(
   ...
   * @return bool
   */
  virtual bool unregisterFrontService(const std::string &_groupID,
...
public:
  ...
  void setP2PInterface(P2PInterface::Ptr _p2pInterface) {
